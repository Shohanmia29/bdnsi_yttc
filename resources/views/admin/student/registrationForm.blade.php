<x-admin-app-layout>
    ...
    <div class="  mt-8 bg-white p-3 print:p-0 min-w-[800px] overflow-x-auto">
          ...
          <div class="absolute top-[44.5%] left-[45.8%]  w-38 ">{{\App\Enums\Gender::fromValue(  $student->gender??'N/A')->key}}</div>
           <div class="absolute top-[48.2%] left-[45.8%]  w-38 ">{{$student->center->name??'N/A'}}/{{$student->center->code??'N/A'}}</div>

          <div class="absolute top-[52%] left-[45.8%]  w-38 ">{{$student->present_address??'N/A'}}</div>
          <div class="absolute top-[55.7%] left-[45.8%]  w-38 ">{{$student->permanent_address??'N/A'}}</div>
