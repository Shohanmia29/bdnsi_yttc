        ...
        <div class="container">
            ...
            <div class="brand-slider owl-carousel owl-theme pb-100">
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/1.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo1.png')}}" class="brand-item-logo2" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/2.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo2.png')}}" class="brand-item-logo2" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/3.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo3.png')}}" class="brand-item-logo2" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/4.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo4.png')}}" class="brand-item-logo2" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/5.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo5.png')}}" class="brand-item-logo2" alt="Images">
                </div>
                <div class="brand-item">
                    <img src="{{asset('frontend/assets/images/brand-logo/6.png')}}" class="brand-item-logo1" alt="Images">
                    <img src="{{asset('frontend/assets/images/brand-logo/brand-logo6.png')}}" class="brand-item-logo2" alt="Images">
                </div>
            </div>
