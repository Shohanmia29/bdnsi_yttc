<x-app-layout>
    ...
    <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap justify-center w-full bg-white p-4">
            ...
            <x-labeled-input readonly  name="present_address" label="District" :value="$student->present_address" required class="w-full p-1 md:w-1/2 lg:w-1/3"/>
            <x-labeled-input  readonly name="permanent_address" label="Upazila" :value="$student->permanent_address" required class="w-full p-1 md:w-1/2 lg:w-1/3"/>
