<x-app-layout>
    ...
    <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap justify-center w-full bg-white p-4">
            ...
            <x-labeled-input name="guardian_name" :value="$student->guardian_name"   class="w-full p-1 md:w-1/2 lg:w-1/3"/>
            <x-labeled-input name="nid_or_birth" :value="$student->nid_or_birth" label="NID or Birth Certificate No."   class="w-full p-1 md:w-1/2 lg:w-1/3"/>
