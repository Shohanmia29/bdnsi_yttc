<x-app-layout>
    ...
    <div class="w-full mt-8 bg-white   ">
        <div class="r-bg relative" style="background-image: url({{asset('images/admit.png')}})">
            <div class="absolute top-[23.3%] left-[12.5%] w-38 text-xs font-bold text-left">{{$student->id??''}}</div>
            <div class="absolute top-[30.3%] left-[19.5%] w-38 text-xs font-bold text-left">{{$student->center_id??''}}</div>
            ...
            <div class="absolute top-[45.5%] left-[62.5%] w-38 text-xs font-bold text-left">{{$student->course->name??''}}ssss</div>
            <div class="absolute top-[51.5%] left-[19.5%] w-38 text-xs font-bold text-left">{{$student->session->name??''}}</div>
            <div class="absolute top-[51.5%] left-[62.5%] w-38 text-xs font-bold text-left">{{$student->course->name??''}}ssss</div>
            <div class="absolute top-[59.5%] left-[19.5%] w-38 text-xs font-bold text-left">{{$student->name??''}}</div>
