    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::beginTransaction();
                ...
                $message = 'Congratulation!! ' . $student->name . ', You have successfully filled the application form for Fastly '.$student->center->name .' ' . $student->subject->name . ' course under Young Technical Training. Your Roll No: ' . $student->roll .' and Registration No: ' . $student->registration . '. Thanks for staying with Young Technical Training Institute.';
